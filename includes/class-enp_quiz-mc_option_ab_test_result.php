...
class Enp_quiz_MC_option_AB_test_result extends Enp_quiz_MC_option {
    ...
    public function set_ab_test_mc_option_results($ab_test_id) {
        self::$results = $this->select_ab_test_question_results_by_question_id($ab_test_id);
    ...
    public function select_ab_test_question_results_by_question_id($ab_test_id) {
        $pdo = new enp_quiz_Db();
        ...
        $sql = "SELECT * from ".$pdo->response_ab_test_table." ab_response
            INNER JOIN ".$pdo->response_mc_option_table." mc_option_response
                    ON ab_response.response_quiz_id = mc_option_response.response_quiz_id
                 WHERE ab_response.ab_test_id = :ab_test_id
                   AND mc_option_response.mc_option_id = :mc_option_id";
