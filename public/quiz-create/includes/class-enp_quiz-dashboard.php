 ...
 *
 * @package    Enp_quiz
 * @subpackage Enp_quiz/public/quiz-dashboard
 */
...
class Enp_quiz_Dashboard extends Enp_quiz_Create {
    ...
    public function enqueue_styles() {
		...
		/*wp_register_style( $this->plugin_name.'-quiz-dashboard', plugin_dir_url( __FILE__ ) . 'css/enp_quiz-dashboard.css', array(), $this->version );
 	  	wp_enqueue_style( $this->plugin_name.'-quiz-dashboard' );*/
	...
	public function enqueue_scripts() {
		...
		wp_register_script( $this->plugin_name.'-quiz-dashboard', plugin_dir_url( __FILE__ ) . 'js/dashboard.js', array( 'jquery' ), $this->version, true );
		wp_enqueue_script( $this->plugin_name.'-quiz-dashboard' );
