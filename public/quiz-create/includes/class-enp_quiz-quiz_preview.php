...
class Enp_quiz_Quiz_preview extends Enp_quiz_Create {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( $this->plugin_name.'-quiz-preview', plugin_dir_url( __FILE__ ) . '../js/quiz-preview.js', array( 'jquery', $this->plugin_name.'-iris', $this->plugin_name.'-accordion' ), $this->version, true );
