...
<div class="enp-container enp-publish-page-container">
    ...
    <div class="enp-flex enp-publish-page-flex-container">
        <section class="enp-container enp-publish-container">
            ...
            <textarea class="enp-embed-code enp-publish-page__embed-code" rows="7"><iframe id="enp-quiz-iframe-<?php echo $quiz->get_quiz_id();?>" class="enp-quiz-iframe" src="<? echo ENP_QUIZ_URL.$quiz->get_quiz_id();?>" style="width: <? echo $quiz->get_quiz_width();?>; height: 500px;"></iframe>

<script type="text/javascript" src="<?php echo ENP_QUIZ_PLUGIN_URL;?>public/quiz-take/js/dist/cross-domain-messaging.js"></script></textarea>
        </section>
