...
<div class="enp-container enp-publish-page-container">
    ...
    <div class="enp-flex enp-publish-page-flex-container">
        <section class="enp-container enp-publish-container">
            ...
            <textarea class="enp-embed-code enp-publish-page__embed-code" rows="7"><script type="text/javascript" src="<?php echo ENP_QUIZ_PLUGIN_URL;?>public/quiz-take/js/dist/iframe-parent.js"></script></textarea>
