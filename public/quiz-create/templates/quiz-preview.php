		...
		<div class="enp-flex enp-preview-page-flex-container">
			<section class="enp-container enp-quiz-settings-container">
				...
				<form class="enp-form enp-quiz-settings__form" method="post" action="<?php echo htmlentities(ENP_QUIZ_PREVIEW_URL . $quiz->get_quiz_id() . '/'); ?>">
					...
					<button type="submit" id="enp-btn--next-step" class="enp-btn--submit enp-btn--next-step enp-preview-form__submit--publish" name="enp-quiz-submit" value="quiz-publish"><?php echo $enp_next_button_name; ?> <svg class="enp-icon enp-icon--chevron-right enp-btn--next-step__icon enp-preview-form__submit__icon">
			...
			<section class="enp-container enp-quiz-preview-container">
				...
				<?php do_action( 'qm/debug', ENP_QUIZ_URL ); ?>
				<?php do_action( 'qm/debug', $quiz->get_quiz_id() );?>
