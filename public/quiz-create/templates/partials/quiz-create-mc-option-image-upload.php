<h1>mc option image upload</h1>
<?php $mc_option = new Enp_quiz_MC_option($mc_option_id); ?>
<label for="enp-mc-option-image-upload-<?php echo $mc_option_id;?>" class="enp-label enp-mc-option-image-upload__label enp-screen-reader-text">Add Image</label>
