...
<input id="enp-mc-option-image-upload-<?php echo $question_id;?>" type="file" accept="image/*" class="enp-mc-option-image-upload__input" name="mc_option_image_upload_<?php echo $mc_option_id;?>">
