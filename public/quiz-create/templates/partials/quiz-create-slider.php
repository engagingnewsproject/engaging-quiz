<fieldset class="enp-slider-options">
    ...
    <div class="enp-slider-range__container">
        <div class="enp-slider-range-low__container">
            ...
            <input id="enp-slider-range-low__<?php echo $slider->get_slider_id();?>" class="enp-input enp-slider-range-low__input" type="number" name="enp_question[<?php echo $question_i;?>][slider][slider_range_low]" value="<?php echo $slider->get_slider_range_low();?>" step="any">
        </div>
        ...
        <div class="enp-slider-range-high__container">
            ...
            <input id="enp-slider-range-high__<?php echo $slider->get_slider_id();?>" class="enp-input enp-slider-range-high__input" type="number" name="enp_question[<?php echo $question_i;?>][slider][slider_range_high]" value="<?php echo $slider->get_slider_range_high();?>" step="any">
        </div>
    </div>
    ...
    <div class="enp-slider-correct__container">
        <div class="enp-slider-correct-low__container">
            ...
            <input id="enp-slider-correct-low__<?php echo $slider->get_slider_id();?>" class="enp-input enp-slider-correct-low__input" type="number" name="enp_question[<?php echo $question_i;?>][slider][slider_correct_low]" value="<?php echo $slider->get_slider_correct_low();?>" step="any">
        </div>
        ...
        <div class="enp-slider-correct-high__container">
            ...
            <input id="enp-slider-correct-high__<?php echo $slider->get_slider_id();?>" class="enp-input enp-slider-correct-high__input" type="number" name="enp_question[<?php echo $question_i;?>][slider][slider_correct_high]" value="<?php echo $slider->get_slider_correct_high();?>" step="any">
        </div>
    </div>
    ...
    <fieldset class="enp-slider-advanced-options__container">
        ...
        <div class="enp-slider-advanced-options__content">
            ...
            <input id="enp-slider-increment__<?php echo $slider->get_slider_id();?>" class="enp-input enp-slider-increment__input" type="number" name="enp_question[<?php echo $question_i;?>][slider][slider_increment]" value="<?php echo $slider->get_slider_increment();?>" step="any">
