<section class="enp-question-content">
    <div class="enp-question-inner enp-question">
        ...
        <textarea class="enp-textarea enp-question-title__textarea" name="enp_question[<?echo $i;?>]['question-title']" placeholder="Why can't we tickle ourselves?"/></textarea>
        ...
        <input type="file" class="enp-image-upload__input" name="enp_question[<?echo $i;?>]['question-image']">


        <h4 class="enp-legend enp-question-type__legend">Question Type</h4>

        <input type="radio" id="enp-question-type__mc" class="enp-radio enp-question-type__input enp-question-type__input--mc" name="enp_question[<?echo $i;?>]['question-type']" value="mc" checked="checked">
        ...
        <input type="radio" id="enp-question-type__slider" class="enp-radio enp-question-type__input enp-question-type__input--slider" name="enp_question[<?echo $i;?>]['question-type']" value="slider">
    ...
    <div class="enp-question-inner enp-answer-explanation">
        <fieldset class="enp-fieldset enp-answer-explanation__fieldset">
            ...
            <textarea class="enp-textarea enp-answer-explanation__textarea" name="enp_question[<?echo $i;?>]['answer-explanation']" placeholder="Your cerebellum can predict your own actions, so you're unable to 'surprise' yourself with a tickle."></textarea>
        </fieldset>
    </div>
</section>
