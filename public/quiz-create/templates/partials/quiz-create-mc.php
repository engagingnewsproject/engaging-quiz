...
<fieldset class="enp-mc-options">
    ...
    <ul class="enp-mc-options__list">
        ...
        <li class="enp-mc-option enp-mc-option--add">
            <button class="enp-btn--add enp-mc-option__add" name="enp-quiz-submit" value="mc-option__add-option__question-<?echo $question_i;?>"><svg class="enp-icon enp-icon--add enp-mc-option__add__icon"><use xlink:href="#icon-add" /></svg> Add Another Option</button>
        </li>
    </ul>
</fieldset>
