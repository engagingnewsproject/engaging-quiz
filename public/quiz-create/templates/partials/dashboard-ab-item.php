...
<li id="enp-dash-item--<?php echo $unique_ab_test_id; ?>" class="enp-dash-item enp-dash-item--published">
	<div class="enp-dash-item__header">
		...
		<ul id="enp-dash-item__nav--<?php echo $unique_ab_test_id; ?>" class="enp-dash-item__nav">
			<li class="enp-dash-item__nav__item">
				<a href="<?php echo ENP_AB_RESULTS_URL . $ab_test->get_ab_test_id(); ?>">
			...
			<li class="enp-dash-item__nav__item"><a href="<?php echo ENP_AB_RESULTS_URL . $ab_test->get_ab_test_id(); ?>#enp-ab-embed-code">
					<svg class="enp-dash-item__icon">
	...
	<div class="enp-dash-item__content">
		<ul class="enp-dash-item__ab-quizzes">
			...
			<!-- <li class="enp-dash-item__ab-quizzes__quiz">A. <?php // echo $quiz_a->get_quiz_title_test(); ?></li> -->
			<!-- <li class="enp-dash-item__ab-quizzes__quiz">B. <?php // echo $quiz_b->get_quiz_title_test(); ?></li> -->
		</ul>
	</div>
</li>