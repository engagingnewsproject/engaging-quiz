<?php
    ...
    if($quiz_status === 'published') {
        ...
        $quiz_title = '<a href="'.$quiz_link.'">'.$quiz->get_quiz_title().'</a>';
        ...
        $quiz_title = '<a href="'.$quiz_link.'"><span class="enp-screen-reader-text">Edit </span>'.$quiz->get_quiz_title().' <svg class="enp-icon enp-dash-item__title__icon"><use xlink:href="#icon-edit" /></svg>';
