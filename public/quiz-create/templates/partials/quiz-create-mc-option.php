<li id="enp-mc-option--<?php echo $mc_option_id;?>" class="enp-mc-option<?php echo ((int)$mc_option->get_mc_option_correct() === 1 ? ' enp-mc-option--correct' : '');?>">
    ...
    <input class="enp-mc-option-id" type="hidden" name="enp_question[<?echo $question_array_i;?>][mc_option][<?echo $mc_option_i;?>][mc_option_id]" value="<? echo $mc_option_id;?>" />

    <input type="text" class="enp-input enp-mc-option__input" name="enp_question[<?echo $question_array_i;?>][mc_option][<?echo $mc_option_i;?>][mc_option_content]" maxlength="255" placeholder="It's one of the great mysteries of the universe." value="<?echo  $mc_option->get_mc_option_content();?>"/>
