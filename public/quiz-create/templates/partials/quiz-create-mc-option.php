<li class="enp-mc-option">
    ...
    <input type="text" class="enp-input enp-mc-option__input" name="enp_question[<?echo $i;?>]['mc-options'][<?echo $mc_option_i;?>]" placeholder="It's one of the great mysteries of the universe."/>
