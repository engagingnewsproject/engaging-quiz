...
<li id="enp-mc-option--<?php echo $mc_option_id;?>" class="enp-mc-option enp-mc-option--inputs<?php echo ((int)$mc_option->get_mc_option_correct() === 1 ? ' enp-mc-option--correct' : '');?>">
	...
	<input id="enp-mc-option-image-<?php echo $mc_option_id;?>" class="enp-mc-option-image__input hide" name="mc_option_image_upload_[<?php echo $mc_option_i;?>][mc_option_image]" value="<?php echo $mc_option_image;?>" />
	<?php
