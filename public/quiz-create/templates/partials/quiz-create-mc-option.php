<li class="enp-mc-option">
    ...
    <input type="text" class="enp-input enp-mc-option__input" name="enp_question[<?echo $question_i;?>][mc_option][<?echo $mc_option_i;?>][mc_option_content]" maxlength="255" placeholder="It's one of the great mysteries of the universe."/>
