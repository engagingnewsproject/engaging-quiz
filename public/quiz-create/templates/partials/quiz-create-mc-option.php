...
<li id="enp-mc-option--<?php echo $mc_option_id;?>" class="enp-mc-option enp-mc-option--inputs<?php echo ((int)$mc_option->get_mc_option_correct() === 1 ? ' enp-mc-option--correct' : '');?>">
	...
	<button type="button" class="enp-btn--add enp-question-image-upload">
	<svg class='enp-icon enp-icon--photo enp-question-image-upload__icon--photo' role='presentation' aria-hidden='true'><use xlink:href='#icon-photo' /></svg>
	</button>
	<?php
