<li class="enp-mc-option<?php echo ((int)$mc_option->get_mc_option_correct() === 1 ? ' enp-mc-option--correct' : '');?>">
    ...
    <button class="enp-mc-option__button enp-mc-option__button--delete" name="enp-quiz-submit" value="mc-option--delete__question-<?echo $question_i;?>__mc-option-<?echo  $mc_option->get_mc_option_id();?>">
