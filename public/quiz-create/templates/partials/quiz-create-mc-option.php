<li class="enp-mc-option">
    ...
    <input type="text" class="enp-input enp-mc-option__input" name="enp_question[<?echo $i;?>]['mc_options'][<?echo $mc_option_i;?>]" maxlength="255" placeholder="It's one of the great mysteries of the universe."/>
