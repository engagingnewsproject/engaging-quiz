<li class="enp-mc-option">
    ...
    <input type="text" class="enp-input enp-mc-option__input" name="enp-question[<?echo $i;?>]['mc-option'][<?echo $mc_option_i;?>]" placeholder="It's one of the great mysteries of the universe."/>
