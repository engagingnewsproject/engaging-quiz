...
$Quiz_create = new Enp_quiz_Quiz_create();
?>
...
<input class="enp-mc-option-order" type="hidden" name="enp_question[<?php echo $question_i;?>][mc_option][<?php echo $mc_option_i;?>][mc_option_order]" value="<?php echo $mc_option_i;?>" />
	...
	<!-- mc_option_image UPLOAD -->
	<input name="enp_question[<?php echo $question_i;?>][mc_option][<?php echo $mc_option_i;?>][mc_option_image]" id="enp-mc-option-image-<?php echo $mc_option_id;?>" class="enp-mc-option-image__input hide" value="<?php echo $mc_option_image;?>" />
	
	<?php echo $Quiz_create->get_mc_option_image_template( 
			$Quiz_create,
			$mc_option_id,
			$mc_option_i,
			$mc_option_image
