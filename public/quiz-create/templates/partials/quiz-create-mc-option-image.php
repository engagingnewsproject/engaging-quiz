<div class="enp-mc-option-image__container">
    ...
    <input id="enp-mc-option-image-alt--<?php echo $mc_option_id;?>" class="enp-input enp-input--has-description enp-question-image-alt__input" type="text" maxlength="3060"  name="enp-mc-option[<?php echo $mc_option_i;?>][mc_option_image_alt]" value="<?php echo $mc_option->get_mc_option_image_alt();?>" aria-describedby="enp-mc-option-image-alt-description--<?php echo $mc_option_id;?>">
