...
<div class="enp-mc-option-image__container">
	...
	<!-- get_quiz_create_mc_option_image -->
	<?php echo $this->get_quiz_create_mc_option_image( $mc_option, $mc_option_id );?>
	<!-- END get_quiz_create_mc_option_image -->

	<button class="enp-button enp-quiz-submit enp-button__question-image-delete" name="enp-quiz-submit" value="enp-mc-option-image--delete-<?php echo $mc_option_id;?>">
		<svg class="enp-icon enp-icon--delete enp-mc-option__icon--question-image-delete">
