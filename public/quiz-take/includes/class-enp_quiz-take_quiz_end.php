...
class Enp_quiz_Take_Quiz_end {
	...
	public function set_quiz_end_content() {
		...
		if ($score < 70) {
			$content = $this->quiz->get_quiz_end_fail_description();
		} elseif ($score < 85) {
			$content = $this->quiz->get_quiz_end_average_description();
		} elseif ($score < 100) {
			$content = $this->quiz->get_quiz_end_good_description();
		} elseif ($score === 100) {
			$content = $this->quiz->get_quiz_end_perfect_description();
		}
