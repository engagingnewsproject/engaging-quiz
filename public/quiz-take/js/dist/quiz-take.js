jQuery( document ).ready( function( $ ) {// UTILITY
    ...
    */
    $(document).on('click', '.enp-option__label', function(e){
        ...
        // It checks if there are any elements with the class '.enp-question__container--unanswered' 
        // and returns false if such elements are not found.
    ...
    */
    function generateQuestionExplanation(questionJSON, correct, callback) {
        ...
        // Calculate Question Response Percentage:
        // retrieves the percentage of responses that were correct or incorrect, as specified by the questionJSON. 
