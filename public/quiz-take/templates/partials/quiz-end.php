<section class="enp-results">
    ...
    <ul class="enp-results__share">
        ...
        <li class="enp-results__share__item"><a class="enp-results__share__link enp-results__share__item--twitter" href="http://twitter.com/intent/tweet?text=<?php echo urlencode('I got '.$qt_end->get_score_percentage().'% right on the '.$qt_end->quiz->get_quiz_title().' Quiz. How well can you do?');?>&url=<?php echo ENP_QUIZ_URL.$qt_end->quiz->get_quiz_id();?>">
