<section class="enp-results">
    ...
    <ul class="enp-results__share">
        ...
        <li class="enp-results__share__item"><a class="enp-results__share__link enp-results__share__item--email" href="mailto:?subject=<?php echo $qt_end->get_share_content('email_subject_end');?>&body=<?php echo $qt_end->get_share_content('email_body_end');?>">
