<fieldset id="question_<?php echo $qt_question->question->get_question_id();?>" class="enp-question__fieldset <?php echo $qt_question->get_question_classes();?>">
    <input id="enp-question-id" class="hidden" name="enp-question-id" value="<?php echo $qt_question->question->get_question_id();?>"/>
    <input id="enp-question-type" class="hidden" name="enp-question-type" value="<?php echo $qt_question->question->get_question_type();?>"/>
