...
<section id="enp-explanation_<?php echo $qt_question->question->get_question_id(); ?>" class="enp-explanation enp-explanation--<?php echo $qt_question->get_question_explanation_title(); ?>"
	...
	<p id="enp-explanation__explanation" class="enp-explanation__explanation">
	<?php
	echo $qt_question->question->get_question_explanation();
	// $question_explanation = $qt_question->question->get_question_explanation();
	// echo wp_kses( $question_explanation, 'post' );
	?>
	</p>
